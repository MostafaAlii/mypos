...
<head>
    ...
    <title>{{trans('general.system_name')}} | @yield('title')</title>
    ...
    <link href="{{asset('dashboard/assets/css/elements/miscellaneous.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('dashboard/assets/css/elements/breadcrumb.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{asset('dashboard/plugins/table/datatable/datatables.css')}}" rel="stylesheet" type="text/css" />
